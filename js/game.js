...
KEY_CODES = {  32: 'space', 37: 'left', 38: 'up', 39: 'right',
    40: 'down', 70: 'f', 71: 'g', 72: 'h', 77: 'm', 80: 'p'
  }
  ...
  Ship = function () {
    ...
    this.preMove = function (delta) {
      ...
      this.children.exhaust.context.closePath();
      this.children.exhaust.context.fillStyle = 'black';
      this.children.exhaust.context.fill();
    };
  ...
  Text = { renderGlyph: function (ctx, face, char) {
    ...
    renderText: function(text, size, x, y) {
      ...
      var pixels = size * 76 / (this.face.resolution * 150);
  ...
  Game = {
    ...
    FSM: {
      ...
      waiting: function () {
        Text.renderText(window.ipad ? 'Touch Screen to Start' : 'Press Space to Start', 45, Game.canvasWidth/2 - 250, Game.canvasHeight/2);
      ...
      end_game: function () {
        Text.renderText('GAME OVER', 70, Game.canvasWidth/2 - 160, Game.canvasHeight/2 + 10);
        if (this.timer == null) {
          this.timer = Date.now();
        }
  ...
  $(function () {
    ...
    var mainLoop = function () {
      ...
      Text.renderText(score_text, 24, Game.canvasWidth - 18 * score_text.length, 28);
